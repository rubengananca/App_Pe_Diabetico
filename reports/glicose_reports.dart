...
class GlicoseReports extends StatefulWidget {
  const GlicoseReports({super.key});

  @override
  State<GlicoseReports> createState() => _GlicoseReportsState();
}

class _GlicoseReportsState extends State<GlicoseReports> {
  ...
  void initState() {
    super.initState();
    _listaRelatorios = _apiService.getFormsInfo("glicose");
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Relatórios da Glicemia",
              ...
              return Card(
                ...
                child: ExpansionTile(
                  ...
                  leading: CircleAvatar(
                    ...
                    child: const Icon(Icons.water_drop_rounded, color: AppColors.blueTitleStatistics),
                  ),
                  
                  title: Text(
                    "Glicose: ${relatorio["glicose_value"]} mg/dL",
                    style: GoogleFonts.poppins(
                      fontSize: 16,
                  ...
                  children: [
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          _detalheItem("Estado da Medição: ", relatorio["state_measure"]),
